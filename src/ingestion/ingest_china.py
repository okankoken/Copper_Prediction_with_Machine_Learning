...
DATASETS = {
    "refined_copper": {
        ...
        "output_file": (
            "market/china_refined_copper_monthly.csv"
        ),
    },
    "industrial_output": {
        "slug": "china-industrial-output",
        "output_file": (
            "macro/china_industrial_output_monthly.csv"
        ),
    },
    "ppi": {
        "slug": "china-ppi",
        "output_file": (
            "macro/china_ppi_monthly.csv"
        ),
    },
    "electricity_generation": {
        "slug": "china-electricity-generation",
        "output_file": (
            "macro/china_electricity_generation_monthly.csv"
        ),
    },
    "fixed_asset_investment": {
        "slug": "china-fai",
        "output_file": (
            "macro/china_fixed_asset_investment_monthly.csv"
        ),
    },
    "real_estate_investment": {
        "slug": "china-real-estate-investment-yoy",
        "output_file": (
            "macro/china_real_estate_investment_monthly.csv"
        ),
    },
}
