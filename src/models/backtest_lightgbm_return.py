...
METRICS_FILE = (
    DIAGNOSTICS_DIR
    / "lightgbm_return_backtest_metrics.csv"
)

FEATURE_USAGE_FILE = (
    DIAGNOSTICS_DIR
    / "lightgbm_return_feature_usage.csv"
)

PARAMETER_FILE = (
    DIAGNOSTICS_DIR
    / "lightgbm_return_parameters.csv"
)
...
def main():
    print("=" * 80)
    print("LIGHTGBM RETURN-TARGET WALK-FORWARD BACKTEST")
    print("=" * 80)
    ...
    if predictions.empty:
        raise RuntimeError(
            "No LightGBM return predictions were produced"
        )
    ...
    print()
    print("=" * 80)
    print("LIGHTGBM RETURN-TARGET RESULTS")
    print("=" * 80)
    print()
